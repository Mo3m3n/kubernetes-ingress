...
| [servers-increment](#servers-slots) | number | 42 |  |:large_blue_circle:|:white_circle:|:white_circle:|
| [server-slots](#server-slots) | number | 42 |  |:large_blue_circle:|:white_circle:|:white_circle:|
...
##### `server-slots`
  ...
  :information_source: This deprecates `servers-increment` annotation.
